...
export const ToolIcon: Record<ToolId, ReactNode> = {
  select: wrap(<path d="M5 3.5 18 11l-5.4 1.6L10 19 5 3.5Z" />),
  line: wrap(
    <>
  ...
  polygon: wrap(<path d="M12 4.2 19 8.3v8.2L12 20.6 5 16.5V8.3Z" />),
  arc: wrap(
    <>
...
export const UiIcon = {
  newFile: wrap(<><path d="M6 3h8l4 4v14H6z" /><path d="M14 3v4h4" /></>),
  open: wrap(<path d="M3 7.5h6l2 2.5h10v8.5a1.5 1.5 0 0 1-1.5 1.5h-15A1.5 1.5 0 0 1 3 18.5Z" />),
  save: wrap(<><path d="M4 4h13l3 3v13H4z" /><path d="M8 4v6h8V4M8 20v-6h8v6" /></>),
  export: wrap(<><path d="M12 15V3m0 0L8.5 6.5M12 3l3.5 3.5" /><path d="M4 14v5.5A1.5 1.5 0 0 0 5.5 21h13a1.5 1.5 0 0 0 1.5-1.5V14" /></>),
  undo: wrap(<><path d="M4 9h11a5 5 0 0 1 0 10H8" /><path d="M4 9l4-4M4 9l4 4" /></>),
  redo: wrap(<><path d="M20 9H9a5 5 0 0 0 0 10h7" /><path d="m20 9-4-4m4 4-4 4" /></>),
  zoomExtents: wrap(<><path d="M3 8V3h5M21 8V3h-5M3 16v5h5M21 16v5h-5" /><rect x="8.5" y="8.5" width="7" height="7" rx="0.5" /></>),
  panel: wrap(<><rect x="3" y="4" width="18" height="16" rx="1" /><path d="M15 4v16" /></>),
  menu: wrap(<><path d="M10 5.5 3.5 12 10 18.5" /><path d="M3.5 12H20" /></>),
};
